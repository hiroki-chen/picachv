...
pub struct ColumnSpecifier {
    #[prost(oneof = "column_specifier::Column", tags = "1, 2")]
    pub column: ::core::option::Option<column_specifier::Column>,
}
/// Nested message and enum types in `ColumnSpecifier`.
pub mod column_specifier {
    #[allow(clippy::derive_partial_eq_without_eq)]
...
pub struct ColumnExpr {
    ...
    pub column: ::core::option::Option<ColumnSpecifier>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct TernaryExpr {
    #[prost(bytes = "vec", tag = "1")]
    pub cond_uuid: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "2")]
    pub then_uuid: ::prost::alloc::vec::Vec<u8>,
    #[prost(bytes = "vec", tag = "3")]
    pub else_uuid: ::prost::alloc::vec::Vec<u8>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ExprArgument {
    #[prost(
        oneof = "expr_argument::Argument",
...
pub struct UnionInformation {
    #[prost(bytes = "vec", repeated, tag = "1")]
    pub df_uuids: ::prost::alloc::vec::Vec<::prost::alloc::vec::Vec<u8>>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
